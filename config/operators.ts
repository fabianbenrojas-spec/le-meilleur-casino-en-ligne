...
export const operators: Operator[] = [
  ...
  },
  {
    ...
    bonusSlug: 'no-bonus',
    rtp: 97.0,
    paymentMethods: ['BTC', 'ETH', 'USDT', 'LTC', 'DOGE', 'XRP', 'SOL'],
    features: [
      'Crypto exclusif 100%',
      'Stake Originals Provably Fair',
      '100k$/jour Daily Races',
      'Aucun wager',
    ],
    pros: [
      'Crypto-first 100 % exclusif — 10+ devises, retraits traités en moins de 2 heures',
      'Stake Originals Provably Fair — jeux propriétaires vérifiables blockchain (RTP 97–99 %)',
      'Partenariats sport mondial premium (UFC sponsor officiel, Stake F1 Team, Drake ambassadeur)',
      'Pas de bonus, pas de wager — promotions via Daily Races 100 000 $/j et Tombola 75 000 $/sem.',
      'Live chat 24h/24, 7j/7 en français — réponse < 2 min (test)',
    ],
    cons: [
      "⚠️ Pas d'ANJ — opérateur Curaçao non agréé en France ; accès via VPN possible avec risque blocage KYC",
      "Pas d'application native ni PWA — site mobile navigateur uniquement",
      'Seuil VIP élitiste : 10 000 € misés pour le niveau Bronze',
      'Exclusivement crypto — aucune méthode de paiement fiat disponible',
      'Note Trustpilot 4,2/5 mitigée (~6 500 avis) — plaintes RTP perçu et KYC tardif',
    ],
    verdict:
      "Stake est le casino crypto-first mondial fondé en 2017, fonctionnant exclusivement en cryptomonnaies (10+ devises) et distribuant ses promotions sans bonus de bienvenue via Daily Races (100 000 $/j) et Tombola hebdomadaire. Ses Stake Originals Provably Fair (Plinko, Mines, Crash) sont vérifiables sur la blockchain. ⚠️ Pas d'ANJ : accès depuis la France via VPN, risque de blocage KYC.",
    tagline: 'Crypto-first mondial — Stake Originals Provably Fair et partenariats premium UFC/F1.',
  ...
  // ── MyStake (enrichi juin 2026) ──────────────────────────────────────────────
  {
    ...
    licenceNumber: 'OGL/2024/1798/1048',
    rating: 7.7,
    ratingLabel: 'Bien',
    bonusAmount: '1 500 €',
    bonusSuffix: ' au choix',
    bonusConditions: 'Wager x30 casino, x10 sport, x60 effectif sur dépôt + bonus',
    bonusAmountNumber: 1500,
    bonusSlug: '1500_euros_au_choix',
    rtp: 96.1,
    paymentMethods: [
      'VISA',
      'MC',
    ...
    features: [
      '4 verticales unifiées',
      'Mini-jeux 60+ exclusifs',
      'Cashback crypto 10% sans wager',
      "Choix 3 bonus à l'inscription",
    ],
    pros: [
      '4 verticales unifiées (casino, sport, e-sport, hippique) dans un compte unique',
      '60+ mini-jeux propriétaires exclusifs développés en interne (Chicken, Dino, Plinko, Crash)',
      'Cashback crypto 10 % sans wager sur chaque dépôt en cryptomonnaie',
      "18 méthodes de dépôt dont 11 cryptos · 3 bonus distincts à l'inscription (1 500 €/600 €/500 €)",
      'Live chat 24h/24, 7j/7 en français',
    ],
    cons: [
      "⚠️ Pas d'ANJ — opérateur Curaçao non agréé en France",
      '⚠️ Délais de retrait réels : 5+ jours (tests 2026) vs 24-48h affichés — SEPA concerné',
      'Aucun retrait par carte bancaire (Visa/Mastercard) — retrait CB non supporté',
      "Pas d'application native ni PWA — site mobile navigateur uniquement",
      'Wager x60 sur le bonus mini-jeux — condition très contraignante',
    ],
    verdict:
      'MyStake est un opérateur offshore fondé en 2019 sous licence Curaçao Gaming Control Board (OGL/2024/1798/1048). Son positionnement repose sur 4 verticales unifiées (casino, sport, e-sport, hippique), 60+ mini-jeux propriétaires exclusifs et un cashback crypto de 10 % sans wager. ⚠️ Non agréé ANJ. Délais de retrait SEPA contestés par des tests indépendants 2026 (5+ jours vs 24-48h affichés). Retrait par carte bancaire non disponible.',
    tagline:
      '4 verticales en 1 compte · 60+ mini-jeux propriétaires · cashback crypto 10 % sans wager.',
    ...
    isAffiliated: true,
    legalDisclaimerVariant: 'offshore-default',
    gameTypes: ['casino', 'sport', 'esports', 'horse-racing'],
    kycPolicy: 'strict',
    withdrawalSpeed: 'standard',
    supportsFrench: true,
    launchYearFrance: 2019,
  },
]
