...
| B-T4 | Versus      | Ajouter `"versus_section_[critère]"` sur les micro-CTAs dans chaque bloc critère                                                                                                                                                                         |
...
| B-T8 | Jeux        | Renommer `"comparison_filter_use"` → `"game_random_pick"` sur le bouton Aléatoire (`GameGrid`) — détecté lors du check B-S6 (2026-06-16). À coupler avec B-T4 lors du lot Versus (même type de correction de naming `data-placement`, périmètre proche). |

### 🟡 Écarts structurels (sections manquantes)

| Réf  | Template    | Action                                                                                                                                                                                                                                                                                                                                                                                                |
| ---- | ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| B-S1 | Avis Casino | Ajouter `review-section#methode` (EEAT : 8 critères de test) dans les sections dynamiques ou en hardcodé après la section `securite`                                                                                                                                                                                                                                                                  |
| B-S2 | Avis Casino | Ajouter `review-section#pour-qui` (rv-profiles : 2 ✓ + 1 ✗) après `methode`                                                                                                                                                                                                                                                                                                                           |
| B-S3 | Avis Casino | Ajouter `#methode` et `#pour-qui` dans les ancres sub-nav + TOC_ITEMS                                                                                                                                                                                                                                                                                                                                 |
...
| B-S5 | Homepage    | Revoir section `blog-grid` pour correspondre au pattern "guides permanents" de la maquette                                                                                                                                                                                                                                                                                                            |
...
| B-S9 | Versus      | Ajouter 2 critères manquants (support client, mobile) dans la table                                                                                                                                                                                                                                                                                                                                   |
