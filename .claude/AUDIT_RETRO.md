...
| B-T8 | Jeux        | Renommer `"comparison_filter_use"` → `"game_random_pick"` sur le bouton Aléatoire (`GameGrid`) — détecté lors du check B-S6 (2026-06-16) |
...
| B-S4 | Homepage    | Ajouter `hp-toplinks` (4 liens opérateurs compacts) et `cat-grid` (5 tuiles catégories)                                                                                                                                                                                                                                            |
