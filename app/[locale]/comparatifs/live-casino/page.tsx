...
export default async function LiveCasinoComparatifPage({
  ...
  const schemaItemList = {
    ...
    '@type': 'ItemList',
    name: isFr ? 'Meilleurs casinos live France 2026' : 'Best Live Casinos France 2026',
    itemListElement: liveFirst.slice(0, 10).map((op, i) => ({
      '@type': 'ListItem',
      position: i + 1,
      name: op.name,
      ...
      editorialContent={
        isFr ? (
          <div className="space-y-4 text-[15.5px] leading-[1.7] text-ink-2">
            ...
            <p>
              La vraie question n&apos;est pas &quot;lequel est le meilleur&quot; mais &quot;lequel
              est disponible dans mon casino&quot;. Les meilleurs opérateurs proposent les deux
              fournisseurs, plus des partenaires exclusifs comme NetEnt Live, Ezugi (propriété
              d&apos;Evolution) ou Playtech Live. Plus un casino a de fournisseurs live, plus le
              choix de tables et de limites est vaste.
            </p>
          </div>
        ) : (
          <div className="space-y-4 text-[15.5px] leading-[1.7] text-ink-2">
            <p>
              Evolution Gaming (EVO) dominates the live casino market with approximately 70% global
              market share. Their competitive advantage: exclusive studios, patented games like
              Lightning Roulette and Crazy Time, and global infrastructure guaranteeing low latency.
              4K video quality and game interfaces are considered the industry standard.
            </p>
            <p>
              ...
              making live casino accessible to all budgets. Their Mega Wheel with multipliers up to
              500× is a direct alternative to Crazy Time. RTPs are slightly higher on some Pragmatic
              vs Evolution games.
            </p>
            <p>
              The real question is not &apos;which is better&apos; but &apos;which is available at
              my casino&apos;. The best operators offer both providers, plus exclusive partners like
              NetEnt Live, Ezugi (owned by Evolution) or Playtech Live. The more live providers a
              casino has, the greater the choice of tables and betting limits.
            </p>
          </div>
        )
      }
      faqH2={
        isFr ? 'Questions fréquentes — Comparatif Live Casino' : 'FAQ — Live Casino Comparison'
      }
